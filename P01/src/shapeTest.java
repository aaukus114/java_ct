...
public class shapeTest {
	public static void main(String[] args) {
		...
		/*
		System.out.println("¿ø :" + ctw.GetArea());
		System.out.println("»ç°¢Çü : " + rtw.GetArea());
		System.out.println("»ï°¢Çü :" + ttw.GetArea());
		*/
		...
		/*
		System.out.println("À°¸éÃ¼ :" + cth.GetVolume());
		System.out.println("¿ø±âµÕ : " + cyth.GetVolume());
